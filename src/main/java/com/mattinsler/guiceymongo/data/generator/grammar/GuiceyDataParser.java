...
public class GuiceyDataParser extends Parser {
    ...
    // $ANTLR start "start"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:31:1: start : ( entry )+ EOF ;
    public final GuiceyDataParser.start_return start() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:32:2: ( ( entry )+ EOF )
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:32:4: ( entry )+ EOF
            {
            root_0 = (Object)adaptor.nil();

            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:32:4: ( entry )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:0:0: entry
            	    {
    ...
    // $ANTLR start "entry"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:35:1: entry : ( data | enumeration );
    public final GuiceyDataParser.entry_return entry() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:36:2: ( data | enumeration )
            int alt2=2;
            alt2 = dfa2.predict(input);
            switch (alt2) {
                case 1 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:36:4: data
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:37:4: enumeration
                    {
                    root_0 = (Object)adaptor.nil();
    ...
    // $ANTLR start "data"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:40:1: data : ( ( javadoc )? DATA ID '{' ( data_entry )* '}' -> ^( DATA ID ( javadoc )? ( data_entry )* ) | ( javadoc )? DATA ID '{}' -> ^( DATA ID ( javadoc )? ) );
    public final GuiceyDataParser.data_return data() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:41:2: ( ( javadoc )? DATA ID '{' ( data_entry )* '}' -> ^( DATA ID ( javadoc )? ( data_entry )* ) | ( javadoc )? DATA ID '{}' -> ^( DATA ID ( javadoc )? ) )
            int alt6=2;
            alt6 = dfa6.predict(input);
            switch (alt6) {
                case 1 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:41:4: ( javadoc )? DATA ID '{' ( data_entry )* '}'
                    {
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:41:4: ( javadoc )?
                    int alt3=2;
                    switch ( input.LA(1) ) {
                        case 30:
                            {
                    ...
                    switch (alt3) {
                        case 1 :
                            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:0:0: javadoc
                            {
                    ...
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:41:25: ( data_entry )*
                    loop4:
                    do {
                        int alt4=2;
                        switch ( input.LA(1) ) {
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:0:0: data_entry
                    	    {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:41:44: ^( DATA ID ( javadoc )? ( data_entry )* )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(stream_DATA.nextNode(), root_1);

                        adaptor.addChild(root_1, stream_ID.nextNode());
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:41:54: ( javadoc )?
                        if ( stream_javadoc.hasNext() ) {
                            adaptor.addChild(root_1, stream_javadoc.nextTree());

                        }
                        stream_javadoc.reset();
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:41:63: ( data_entry )*
                    ...
                    break;
                case 2 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:42:4: ( javadoc )? DATA ID '{}'
                    {
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:42:4: ( javadoc )?
                    int alt5=2;
                    switch ( input.LA(1) ) {
                        case 30:
                            {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:42:29: ^( DATA ID ( javadoc )? )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(stream_DATA.nextNode(), root_1);

                        adaptor.addChild(root_1, stream_ID.nextNode());
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:42:39: ( javadoc )?
                        if ( stream_javadoc.hasNext() ) {
                            adaptor.addChild(root_1, stream_javadoc.nextTree());
    ...
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:45:1: enumeration : ( ( javadoc )? ENUM ID '{}' -> ^( ENUM ID ( javadoc )? ) | ( javadoc )? ENUM ID '{' ( ID ',' )* ID '}' -> ^( ENUM ( ID )+ ( javadoc )? ) );
    public final GuiceyDataParser.enumeration_return enumeration() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_javadoc=new RewriteRuleSubtreeStream(adaptor,"rule javadoc");
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:46:2: ( ( javadoc )? ENUM ID '{}' -> ^( ENUM ID ( javadoc )? ) | ( javadoc )? ENUM ID '{' ( ID ',' )* ID '}' -> ^( ENUM ( ID )+ ( javadoc )? ) )
            int alt10=2;
            alt10 = dfa10.predict(input);
            switch (alt10) {
                case 1 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:46:4: ( javadoc )? ENUM ID '{}'
                    {
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:46:4: ( javadoc )?
                    int alt7=2;
                    switch ( input.LA(1) ) {
                        case 30:
                            {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:46:29: ^( ENUM ID ( javadoc )? )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(stream_ENUM.nextNode(), root_1);

                        adaptor.addChild(root_1, stream_ID.nextNode());
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:46:39: ( javadoc )?
                        if ( stream_javadoc.hasNext() ) {
                            adaptor.addChild(root_1, stream_javadoc.nextTree());
                    ...
                    break;
                case 2 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:47:4: ( javadoc )? ENUM ID '{' ( ID ',' )* ID '}'
                    {
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:47:4: ( javadoc )?
                    int alt8=2;
                    switch ( input.LA(1) ) {
                        case 30:
                            {
                    ...
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:47:25: ( ID ',' )*
                    loop9:
                    do {
                        int alt9=2;
                        switch ( input.LA(1) ) {
                        ...
                        switch (alt9) {
                    	case 1 :
                    	    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:47:26: ID ','
                    	    {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:47:45: ^( ENUM ( ID )+ ( javadoc )? )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(stream_ENUM.nextNode(), root_1);
                        ...
                        stream_ID.reset();
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:47:56: ( javadoc )?
                        if ( stream_javadoc.hasNext() ) {
                            adaptor.addChild(root_1, stream_javadoc.nextTree());
    ...
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:50:1: data_entry : ( entry | ( javadoc )? ( option )* property -> ^( property ( javadoc )? ( option )* ) );
    public final GuiceyDataParser.data_entry_return data_entry() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:51:2: ( entry | ( javadoc )? ( option )* property -> ^( property ( javadoc )? ( option )* ) )
            int alt13=2;
            alt13 = dfa13.predict(input);
            switch (alt13) {
                case 1 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:51:4: entry
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:52:4: ( javadoc )? ( option )* property
                    {
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:52:4: ( javadoc )?
                    int alt11=2;
                    switch ( input.LA(1) ) {
                        case 30:
                            {
                    ...
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:52:13: ( option )*
                    loop12:
                    do {
                        int alt12=2;
                        switch ( input.LA(1) ) {
                        ...
                        switch (alt12) {
                    	case 1 :
                    	    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:0:0: option
                    	    {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:52:33: ^( property ( javadoc )? ( option )* )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(stream_property.nextNode(), root_1);

                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:52:44: ( javadoc )?
                        if ( stream_javadoc.hasNext() ) {
                            adaptor.addChild(root_1, stream_javadoc.nextTree());

                        }
                        stream_javadoc.reset();
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:52:53: ( option )*
    ...
    // $ANTLR start "javadoc"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:55:1: javadoc : '/*' comment '*/' -> ^( COMMENT comment ) ;
    public final GuiceyDataParser.javadoc_return javadoc() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:56:2: ( '/*' comment '*/' -> ^( COMMENT comment ) )
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:56:4: '/*' comment '*/'
            {
            ...
            {
                // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:56:25: ^( COMMENT comment )
                {
                Object root_1 = (Object)adaptor.nil();
    ...
    // $ANTLR start "comment"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:59:1: comment : (~ ( '*/' ) )* ;
    public final GuiceyDataParser.comment_return comment() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:60:2: ( (~ ( '*/' ) )* )
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:60:4: (~ ( '*/' ) )*
            {
            root_0 = (Object)adaptor.nil();
            ...
            do {
                ...
                switch (alt14) {
            	case 1 :
            	    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:0:0: ~ ( '*/' )
            	    {
    ...
    // $ANTLR start "option"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:63:1: option : ( '[' ID ']' -> ^( OPTION ID ) | '[' ID '(' value ')]' -> ^( OPTION ID value ) | '[' ID '(' ( pair ',' )* pair ')]' -> ^( OPTION ID ( pair )+ ) );
    public final GuiceyDataParser.option_return option() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:64:2: ( '[' ID ']' -> ^( OPTION ID ) | '[' ID '(' value ')]' -> ^( OPTION ID value ) | '[' ID '(' ( pair ',' )* pair ')]' -> ^( OPTION ID ( pair )+ ) )
            int alt16=3;
            switch ( input.LA(1) ) {
            case 32:
                {
            ...
            switch (alt16) {
                case 1 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:64:4: '[' ID ']'
                    {
                    ...
                    // 64:15: -> ^( OPTION ID )
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:64:18: ^( OPTION ID )
                        {
                        Object root_1 = (Object)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:65:4: '[' ID '(' value ')]'
                    {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:65:29: ^( OPTION ID value )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(OPTION, "OPTION"), root_1);
                    ...
                    break;
                case 3 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:67:4: '[' ID '(' ( pair ',' )* pair ')]'
                    {
                    ...
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:67:15: ( pair ',' )*
                    loop15:
                    do {
                        int alt15=2;
                        switch ( input.LA(1) ) {
                        ...
                        switch (alt15) {
                    	case 1 :
                    	    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:67:16: pair ','
                    	    {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:67:40: ^( OPTION ID ( pair )+ )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(OPTION, "OPTION"), root_1);
    ...
    // $ANTLR start "pair"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:70:1: pair : key '=' value -> ^( PAIR key value ) ;
    public final GuiceyDataParser.pair_return pair() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:71:2: ( key '=' value -> ^( PAIR key value ) )
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:71:4: key '=' value
            {
            ...
            {
                // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:71:21: ^( PAIR key value )
                {
                Object root_1 = (Object)adaptor.nil();
    ...
    // $ANTLR start "key"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:74:1: key : ID ;
    public final GuiceyDataParser.key_return key() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:75:2: ( ID )
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:75:4: ID
            {
            root_0 = (Object)adaptor.nil();
    ...
    // $ANTLR start "value"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:77:1: value : ( INT | FLOAT | STRING );
    public final GuiceyDataParser.value_return value() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:78:2: ( INT | FLOAT | STRING )
    ...
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:83:1: property : ( type 'data;' -> ^( PROPERTY 'data' type ) | type ID ';' -> ^( PROPERTY ID type ) );
    public final GuiceyDataParser.property_return property() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:91:2: ( type 'data;' -> ^( PROPERTY 'data' type ) | type ID ';' -> ^( PROPERTY ID type ) )
            int alt17=2;
            switch ( input.LA(1) ) {
            case 39:
                {
            ...
            switch (alt17) {
                case 1 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:91:4: type 'data;'
                    {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:91:20: ^( PROPERTY 'data' type )
                        {
                        Object root_1 = (Object)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:92:4: type ID ';'
                    {
                    ...
                    {
                        // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:92:19: ^( PROPERTY ID type )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot((Object)adaptor.create(PROPERTY, "PROPERTY"), root_1);
    ...
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:95:1: key_type : type ;
    public final GuiceyDataParser.key_type_return key_type() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:96:2: ( type )
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:96:4: type
            {
            root_0 = (Object)adaptor.nil();
    ...
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:99:1: value_type : type ;
    public final GuiceyDataParser.value_type_return value_type() throws RecognitionException {
        ...
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:100:2: ( type )
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:100:4: type
            {
            root_0 = (Object)adaptor.nil();
    ...
    // $ANTLR start "type"
    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:103:1: type : ( 'map<' type ',' type '>' -> TYPE_MAP ( type )+ | 'set<' type '>' -> TYPE_SET type | 'list<' type '>' -> TYPE_LIST type | TYPE -> TYPE_PRIMITIVE TYPE | ID -> TYPE_PRIMITIVE ID | ID '<' type ( ',' type )* '>' -> PARAMETERIZED_TYPE ID ( type )+ );
    public final GuiceyDataParser.type_return type() throws RecognitionException {
        ...
        RewriteRuleSubtreeStream stream_type=new RewriteRuleSubtreeStream(adaptor,"rule type");
        try {
            // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:104:2: ( 'map<' type ',' type '>' -> TYPE_MAP ( type )+ | 'set<' type '>' -> TYPE_SET type | 'list<' type '>' -> TYPE_LIST type | TYPE -> TYPE_PRIMITIVE TYPE | ID -> TYPE_PRIMITIVE ID | ID '<' type ( ',' type )* '>' -> PARAMETERIZED_TYPE ID ( type )+ )
            int alt19=6;
            switch ( input.LA(1) ) {
            case 39:
                {
            ...
            switch (alt19) {
                case 1 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:104:4: 'map<' type ',' type '>'
                    {
                    ...
                    break;
                case 2 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:105:4: 'set<' type '>'
                    {
                    ...
                    break;
                case 3 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:106:4: 'list<' type '>'
                    {
                    ...
                    break;
                case 4 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:107:4: TYPE
                    {
                    ...
                    break;
                case 5 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:108:4: ID
                    {
                    ...
                    break;
                case 6 :
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:109:4: ID '<' type ( ',' type )* '>'
                    {
                    ...
                    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:109:16: ( ',' type )*
                    loop18:
                    do {
                        int alt18=2;
                        switch ( input.LA(1) ) {
                        ...
                        switch (alt18) {
                    	case 1 :
                    	    // com/mattinsler/guiceymongo/data/generator/grammar/GuiceyData.g:109:17: ',' type
                    	    {
