...
public class TypeGenerator {
	...
	private void createUpdater(Appendable builder, UserDataType type, int indentCount) throws IOException {
		...
		appendIndent(builder, indentCount).append("public static class Updater extends ").append(getSimpleName(type.getJavaType())).append(" implements com.mattinsler.guiceymongo.data.IsUpdatable<").append(getSimpleName(type.getJavaType())).append("> {\n");
	...
	private void createBuilder(Appendable builder, UserDataType type, int indentCount) throws IOException {
		appendIndent(builder, indentCount).append("public static class Builder extends ").append(getSimpleName(type.getJavaType())).append(" implements com.mattinsler.guiceymongo.data.IsBuilder<").append(getSimpleName(type.getJavaType())).append("> {\n");
	...
	private void createWrapper(Appendable builder, UserDataType type, int indentCount) throws IOException {
		appendIndent(builder, indentCount).append("public static class Wrapper extends ").append(getSimpleName(type.getJavaType())).append(" implements com.mattinsler.guiceymongo.data.IsWrapper<").append(getSimpleName(type.getJavaType())).append("> {\n");
...
//		appendIndent(builder, indentCount + 1).append("}\n");
		...
		appendIndent(builder, indentCount).append("public static com.mattinsler.guiceymongo.data.DataWrapper<").append(type.getJavaType()).append("> DataWrapper = new com.mattinsler.guiceymongo.data.DataWrapper<").append(type.getJavaType()).append(">() {\n");
		...
		appendIndent(builder, indentCount).append("public static ").append(type.getJavaType()).append(".Wrapper convertFrom(com.mattinsler.guiceymongo.data.IsWrapper<?> wrapped) {\n");
		...
		appendIndent(builder, indentCount).append("public static ").append(type.getJavaType()).append(".Wrapper convertFrom(com.mattinsler.guiceymongo.data.IsData data) {\n");
		appendIndent(builder, indentCount + 1).append("if (data == null || !(data instanceof com.mattinsler.guiceymongo.data.IsWrapper<?>))\n");
		appendIndent(builder, indentCount + 2).append("return null;\n");
		appendIndent(builder, indentCount + 1).append("return new ").append(type.getJavaType()).append(".Wrapper(((com.mattinsler.guiceymongo.data.IsWrapper<?>)data).getDBObject());\n");
		appendIndent(builder, indentCount).append("}\n");
	}
	...
	private void createUserType(Appendable builder, UserDataType type, int indentCount, boolean innerClass) throws IOException {
		...
		appendIndent(builder, indentCount).append(" * ").append(type.getComment()).append('\n');
		appendIndent(builder, indentCount).append(" */\n");
		appendIndent(builder, indentCount).append("public " + (innerClass ? "static " : "") + "abstract class ").append(getSimpleName(type.getJavaType())).append(" implements com.mattinsler.guiceymongo.data.IsData {\n");
