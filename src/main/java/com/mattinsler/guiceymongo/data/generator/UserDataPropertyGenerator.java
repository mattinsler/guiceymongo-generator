...
//		appendIndent(builder, indentCount).append("public static final com.mattinsler.guiceymongo.data.DocumentProperty<").append(property.getEnclosingType().getCanonicalJavaType()).append(", ").append(property.getType().getCanonicalJavaType()).append("> ").append(property.getKeyName()).append(" = com.mattinsler.guiceymongo.data.DocumentProperty.create(\"").append(property.getKeyValue()).append("\");\n");
